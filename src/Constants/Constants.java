...
//                return (size-10)/(Reproduce.maxSize-10) * maxStomachSize;
        ...
        public static class Energy{
            ...
            public static double armourGrowthMultiplier(double armour){return 1+0.5*armour/Combat.maxArmour;}
        }
...
//            return temp>(Math.PI)?Math.PI*2-temp:temp;
    ...
    public static class Vector2D{
        ...
        public Vector2D normalize(){
            ...
            this.y/=strength;
            return this;}
        public Vector2D multiply(double multiplier){this.x*=multiplier;this.y*=multiplier;return this;}
        public Vector2D multiply(double mx,double my){this.x*=mx;this.y*=my;return this;}
        public Vector2D divide(double divider){this.x/=divider;this.y/=divider;return this;}
        public Vector2D subtract(double dx,double dy){this.x-=dx;this.y-=dy;return this;}
