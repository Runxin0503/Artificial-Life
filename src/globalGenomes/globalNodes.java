...
import static Constants.Constants.NeuralNet.inputNum;
import static Constants.Constants.NeuralNet.outputNum;
import static Constants.Constants.NeuralNet.hiddenAF;
import static Constants.Constants.NeuralNet.outputAF;
...
public class globalNodes {
    ...
    public globalNodes(){
        ...
        for(int i=inputNum;i<inputNum+outputNum;i++)primitiveNodes.add(new node("output",i,0.9,(i + 1-inputNum) / (outputNum + 1.0),outputAF));
    }
    ...
    public int size(){return primitiveNodes.size();}
}
