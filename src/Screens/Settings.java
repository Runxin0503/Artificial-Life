...
//            world.fastForward(WorldConstants.Settings.ticksToSecond*3600*24);
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        addSlider(-1, 999, WorldConstants.Settings.ticksPerSec, (int val) -> {
            WorldConstants.Settings.ticksPerSec = val;
        }, gbc);
        gbc.gridx++;
        addSlider(0, 500, WorldConstants.WorldGen.startingPopulation, (int val) -> {
            WorldConstants.WorldGen.startingPopulation = val;
        }, gbc);
        gbc.gridx = 0;
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        addSlider(0, 500, WorldConstants.WorldGen.naturalSpawningThreshold, (int val) -> {
            WorldConstants.WorldGen.naturalSpawningThreshold = val;
        }, gbc);
        gbc.gridx++;
        addSlider(0, 2000, (int) (BushConstants.energy * 100), (int val) -> {
            BushConstants.energy = val / 100.0;
        }, gbc);
        gbc.gridx = 0;
        gbc.gridy++;
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        addSlider(0, 80, BushConstants.maxBerries, (int val) -> {
            BushConstants.maxBerries = val;
        }, gbc);
        gbc.gridx++;
        addSlider(0, 3000, (int) (CreatureConstants.Boids.minHerdingSpeed * 100), (int val) -> {
            CreatureConstants.Boids.minHerdingSpeed = val * 0.01;
        }, gbc);
        gbc.gridx = 0;
        gbc.gridy++;
        ...
        gbc.gridx++;
        addButtonPlusMinus(() -> {
            int bushMaxWidth = BushConstants.initialMaxSize * ImageConstants.bushWidth / 20;
            ...
            world.Bushes.remove(world.Bushes.size() - 1);
        }, gbc);
        gbc.gridx = 0;
        ...
        gbc.gridx++;
        addButton("Toggle", () -> {
            WorldConstants.Settings.devMode = !WorldConstants.Settings.devMode;
        }, gbc);
        gbc.gridx = 0;
        ...
        gbc.gridx++;
        addButton("Toggle", () -> {
            WorldConstants.WorldGen.spawnCorpse = !WorldConstants.WorldGen.spawnCorpse;
        }, gbc);
        gbc.gridx = 0;
