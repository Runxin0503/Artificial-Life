...
import Constants.Constants.CorpseConstants;
...
public class Corpse extends Movable implements Serializable {
    ...
    private void clearQueue() {
        ...
        while (energy > 0 && !queuedQuestionableMunching.isEmpty()) {
            ...
            if (c.addMeatMass(damageDealt / CreatureConstants.Stomach.meatMassToEnergy))
    ...
    public double getMass() {
        return size * size * CorpseConstants.sizeMovementConstant;
    }
